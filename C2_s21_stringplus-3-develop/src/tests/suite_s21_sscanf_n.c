...
Suite *suite_s21_sscanf_n(void) {
  Suite *s = suite_create("\033[42m-=s21_scanf_n=-\033[0m");
  ...
  tcase_add_test(tc, sscanf_spec_n_12);
  tcase_add_test(tc, sscanf_spec_olo_1);
  tcase_add_test(tc, sscanf_spec_olo_2);
  tcase_add_test(tc, sscanf_spec_olo_3);
  tcase_add_test(tc, sscanf_spec_olo_4);
  tcase_add_test(tc, sscanf_spec_olo_5);
