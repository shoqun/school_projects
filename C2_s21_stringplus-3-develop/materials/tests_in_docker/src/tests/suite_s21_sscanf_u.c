...
START_TEST(sscanf_spec_hhu_1) {
  ...
  int16_t res1 = s21_sscanf(str, format, &u1);
  int16_t res2 = sscanf(str, format, &u2);
...
START_TEST(sscanf_spec_llu_7) {
  char format[] = "%1llu";
  char str[] = "-123";
  unsigned long long int u1 = 0, u2 = 0;
...
Suite *suite_s21_sscanf_u(void) {
  Suite *s = suite_create("\033[42m-=s21_scanf_u=-\033[0m");
  ...
  tcase_add_test(tc, sscanf_spec_hhu_26);
  ...
  tcase_add_test(tc, sscanf_spec_hu_26);
  ...
  tcase_add_test(tc, sscanf_spec_lu_26);
  ...
  tcase_add_test(tc, sscanf_spec_llu_26);
