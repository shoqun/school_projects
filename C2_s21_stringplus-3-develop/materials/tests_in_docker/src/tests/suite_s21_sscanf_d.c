...
START_TEST(sscanf_spec_hhd_26) {
  char format[] = "%hhd";
  char str[] = "9223372036854775800111";
  signed char d1 = 0, d2 = 0;
...
START_TEST(sscanf_spec_hhd_27) {
  char format[] = "%hhd %hhd %hhd %hhd";
  char str[] = "INF inf NaN nan";
  signed char d1 = 0, d2 = 0, d3 = 0, d4 = 0, d5 = 0, d6 = 0, d7 = 0, d8 = 0;

  int16_t res1 = s21_sscanf(str, format, &d1, &d3, &d5, &d7);
  int16_t res2 = sscanf(str, format, &d2, &d4, &d6, &d8);
  ck_assert_int_eq(res1, res2);
  ck_assert_int_eq(d1, d2);
...
START_TEST(sscanf_spec_hd_27) {
  char format[] = "%hd %hd %hd %hd";
  char str[] = "INF inf NaN nan";
  short d1 = 0, d2 = 0, d3 = 0, d4 = 0, d5 = 0, d6 = 0, d7 = 0, d8 = 0;
...
START_TEST(sscanf_spec_ld_27) {
  ...
  char str[] = "INF inf NaN nan";
  long int d1 = 0, d2 = 0, d3 = 0, d4 = 0, d5 = 0, d6 = 0, d7 = 0, d8 = 0;
...
Suite *suite_s21_sscanf_d(void) {
  Suite *s = suite_create("\033[42m-=s21_scanf_d=-\033[0m");
  ...
  tcase_add_test(tc, sscanf_spec_hhd_26);
  tcase_add_test(tc, sscanf_spec_hhd_27);
  ...
  tcase_add_test(tc, sscanf_spec_hd_26);
  tcase_add_test(tc, sscanf_spec_hd_27);
  ...
  tcase_add_test(tc, sscanf_spec_d_26);
  tcase_add_test(tc, sscanf_spec_d_27);
  ...
  tcase_add_test(tc, sscanf_spec_lld_26);
  tcase_add_test(tc, sscanf_spec_lld_27);
